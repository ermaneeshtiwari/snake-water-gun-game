...
<head>
  ...
  <style>
    ...
    .container {{ text-align: center; background: #16213e; padding: 2rem 3rem; border-radius: 12px; box-shadow: 0 4px 20px rgba(0,0,0,0.4); max-width: 480px; width: 100%; }}
    ...
    button {{ background: #e94560; color: white; border: none; padding: 0.75rem 1.5rem; border-radius: 8px; font-size: 1rem; cursor: pointer; transition: background 0.2s; }}
    button:hover {{ background: #c73652; }}
    .result {{ background: #0f3460; padding: 1rem; border-radius: 8px; min-height: 3rem; display: flex; align-items: center; justify-content: center; }}
...
<body>
  <main class="container">
    ...
    <a href="/api/play" class="small">Play again</a>
